<!-- CODICE CHE SERVE SIA PER VERSIONE 1 CHE 2 
...
FINE CODICE CHE SERVE SIA PER LA VERSIONE 1 CHE 2-->
<!--==================================================================================-->
...
.main-header {
  ...
  left: 0;
  top: 0;
  position: relative;     /* O usa fixed se vuoi che resti sempre visibile anche scrollando */
  display: flex;
  align-items: center;
  background: #404149;
  padding: 0.5rem 2rem;
...
.main-content {
  flex: 1;
  padding: 2rem;
  margin-top: 80px; /* Aggiusta in base all'altezza dell'header */
