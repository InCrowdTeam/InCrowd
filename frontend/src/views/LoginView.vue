<template>
  <div class="login-container">
    ...
    <p style="border-top: 1px solid #ccc; margin-top: 1.5rem; padding-top: 1rem;">Non sei ancora registrato? <RouterLink to="/addUser" style="color:#fe4654">Registrati</RouterLink></p>
